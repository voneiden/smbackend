...
## [3.20.0](https://github.com/voneiden/smbackend/compare/smbackend-v3.19.3...smbackend-v3.20.0) (2026-09-05)


### Features

* Adapt to new statistical districts API ([24c5564](https://github.com/voneiden/smbackend/commit/24c55645b8f74ec45c7936e28c4b663e64a89a15))
* Add manual maintenance organization override for specific units ([4fe1616](https://github.com/voneiden/smbackend/commit/4fe1616ad02041b1548c2fbb4fe58b8c96961f36))
* Allow dynamic sentry trace ignore paths ([d66f861](https://github.com/voneiden/smbackend/commit/d66f861995627245e9d19977a54221523235f80c))
* Allow Sentry uWSGI-plugin to be optional ([22694c0](https://github.com/voneiden/smbackend/commit/22694c0c371fa25dfed6b02819a287e949c101f6))
* Change logging format to json ([b639314](https://github.com/voneiden/smbackend/commit/b6393143214f904192dc1a36a7b886d71fd69205))
* Combine school district update commands ([351a482](https://github.com/voneiden/smbackend/commit/351a482c381e9c805627fe9c3b4100ba1051c5d0))
* Configure uwsgi for json logging ([b844fed](https://github.com/voneiden/smbackend/commit/b844fedbd71ad62b136ec6cc88ec638c221e45eb))
* **division:** Set units to empty if no units are found ([3aade0e](https://github.com/voneiden/smbackend/commit/3aade0eeb5a142ac1ecb2c77e2ef39c84a20fb14))
* Enable request id logging ([21a2da9](https://github.com/voneiden/smbackend/commit/21a2da937689ec7f8907c6f1ba98222e1b3ff27d))
* Implement django-csp ([63cca17](https://github.com/voneiden/smbackend/commit/63cca172020e655d0a93f4c22d0da421a09c732c))
* Import Espoo divisions once a week ([8b523bb](https://github.com/voneiden/smbackend/commit/8b523bbb4d604c92972e7cb0b3a379bd76caa52a))
* Improve uWSGI options ([9355f55](https://github.com/voneiden/smbackend/commit/9355f55774904ef86e5a2a12cfa6356ec4f45e73))
* **lipas_import:** Add Siuntio and Inkoo to Lipas-imports ([782fd94](https://github.com/voneiden/smbackend/commit/782fd9485f51257ac3d98121339e53ab58632805))
* **observations:** Add initial observable properties for sledding ([72bfe02](https://github.com/voneiden/smbackend/commit/72bfe02b25fdbc8a071e78bba00535889525aa71))
* **observations:** Add new allowed value for swimming conditions ([4affe41](https://github.com/voneiden/smbackend/commit/4affe41b06d8ca722b711a08646084c367863b0a))
* Picture url rewrite support and endpoints ([6b0f342](https://github.com/voneiden/smbackend/commit/6b0f342b7816043f7a199b78f75ebaf185d713f4))
* Remove release notes script ([8379d72](https://github.com/voneiden/smbackend/commit/8379d72727ede64f9e95445b94bc47afc61b74bf))
* **school:** Import school districts without units ([be5f514](https://github.com/voneiden/smbackend/commit/be5f5142a61892ecf43b1f859b4dd17f82745169))
* **school:** Run school district import inside a transaction ([6e131a4](https://github.com/voneiden/smbackend/commit/6e131a48a06570fc91503ca812485fcd4609127b))
* **sentry:** Update sentry configuration ([f2ff4b9](https://github.com/voneiden/smbackend/commit/f2ff4b9ad2f609e668bc7d3e6f3ce513aebdf71a))
* **services:** Add retry logic and timeout to external API calls ([3835300](https://github.com/voneiden/smbackend/commit/383530073731cf991fe5a6309126639c56d06136))
* Switch to City of Helsinki's UBI GDAL image ([f17857f](https://github.com/voneiden/smbackend/commit/f17857f902aa2ecdd13a0bd10d8e78fd2f6effb0))
* Update accessibility rules ([f9190bf](https://github.com/voneiden/smbackend/commit/f9190bfb1fb0948d87d76f2912e5eeb0aa309a72))
* Update accessibility rules for restaurants ([9f1e6d0](https://github.com/voneiden/smbackend/commit/9f1e6d03e527048783fd2ea8aab0e50deefb07af))
* Update indoor facility accessibility rules ([2b66175](https://github.com/voneiden/smbackend/commit/2b661758339142f899c9228b84306db505f328d9))
* Update outdoor sports facility accessibility rules ([8eabf34](https://github.com/voneiden/smbackend/commit/8eabf340f500f945d1f9b7581bd31171ec88c74e))
* Update sledding initial observable props ([3169af2](https://github.com/voneiden/smbackend/commit/3169af2820dbaaaa433d5bf14debebc22c47192f))
* Use database password if present in env ([#284](https://github.com/voneiden/smbackend/issues/284)) ([3eb710e](https://github.com/voneiden/smbackend/commit/3eb710ef9d19fa33ec0d4e95adefa07ea7dfb05d))
* Use django-helsinki-health-endpoints for readiness and healthz ([410b16b](https://github.com/voneiden/smbackend/commit/410b16b701ea289e2b3c8e49548097d97e5eb2df))
* **vantaa parking areas:** Support MultiLineString and fix pagination ([a879ec3](https://github.com/voneiden/smbackend/commit/a879ec3667804d0049a3a6ef5cc999a082a992b4))


### Bug Fixes

* **accessibility:** Add null check for variable_path ([e19a39d](https://github.com/voneiden/smbackend/commit/e19a39d29cc64ed09d2a38bee1efb4a722a5cc7e))
* Add explicit PROJECTION_SRID-setting ([303f554](https://github.com/voneiden/smbackend/commit/303f554cdf15698a93b92351103b0ace2a77fcbb))
* Add import data path to settings ([63d4f3d](https://github.com/voneiden/smbackend/commit/63d4f3dbf9f852ec64af3841f11b835521bf8aca))
* Add missing cors headers for sentry ([2be7dfa](https://github.com/voneiden/smbackend/commit/2be7dfa6f5f66620dc0b831a43edd5bfe3d04d0c))
* Handle missing ServiceNodes in unit count aggregation ([f5a00d8](https://github.com/voneiden/smbackend/commit/f5a00d8b693be9101abc4d548fd9f543277d742e))
* **import:** Skip broken divisions in school district import ([bbb9cc3](https://github.com/voneiden/smbackend/commit/bbb9cc37f5f7ee1762327cd54569c24abf471cdb))
* Include only active units to search view ([6c9f9d2](https://github.com/voneiden/smbackend/commit/6c9f9d2b05b2d0c5836f966906b9f549e048ba7a))
* **lipas_import_3d:** Skip corrupted GML features and fix WFS 3D parsing ([a320056](https://github.com/voneiden/smbackend/commit/a320056a2a7ec44530c33063e323d194ac11a641))
* Mock geocode_address in test_address_filter ([85ad493](https://github.com/voneiden/smbackend/commit/85ad493b80e6fa317731a79d8ddccb5f9646c24c))
* Prevent SQL injection in search queries ([11a0ae7](https://github.com/voneiden/smbackend/commit/11a0ae7143689286750c9086f237b21bd242dca7))
* Remove 'py-call-uwsgi-fork-hooks'-option ([9b09a11](https://github.com/voneiden/smbackend/commit/9b09a11e0073f9306b6d0f4bc8a5e447c6112816))
* Remove default value for secret key ([58aba58](https://github.com/voneiden/smbackend/commit/58aba5874d3712a5b6b2a65a0ebb78358da24aa2))
* Retain earlier district data on importer error ([2e412a2](https://github.com/voneiden/smbackend/commit/2e412a268d458a47bd4c8e818958551281c1d87d))
* Return use of certain base image ([38edd25](https://github.com/voneiden/smbackend/commit/38edd2574b685a5ef0337bf5e085b7f88ee423d0))
* **search:** Rework search query building ([b3e70c4](https://github.com/voneiden/smbackend/commit/b3e70c40d87d9b83d34b50c1755826ff1f88a00b))
* **search:** Sanitize search query operands better ([b5032c6](https://github.com/voneiden/smbackend/commit/b5032c63ae1ef17c52e8ead2dab9b94b26a4c162))
* **services:** Eliminate n+1 query in unit detail endpoint ([6bb0d8f](https://github.com/voneiden/smbackend/commit/6bb0d8f1c552c418444d3c0cfc97cb43b73e845f))
* Test sonar ([20bc4fa](https://github.com/voneiden/smbackend/commit/20bc4fa7f1b15888344c28817432afd175bc0f89))
* Update sledding initial observable props ([db9fbfe](https://github.com/voneiden/smbackend/commit/db9fbfe8ecf96d31df0b2b9ba4ca7f0078e66ae2))
* Update uwsgi-config for Sentry ([ee45ee1](https://github.com/voneiden/smbackend/commit/ee45ee1cba143487b4cea9f7b2a131ce6db0b480))
* Update Vantaa stat-districts forecast import ([8a51dfc](https://github.com/voneiden/smbackend/commit/8a51dfcb9b1bc692167ecf5156cbd7e73a0b874c))
* Use certain base image for older gdal ([c3c3d86](https://github.com/voneiden/smbackend/commit/c3c3d86ad2129c48633294b6141a762bd3408200))
* Use latest base image ([ab6418c](https://github.com/voneiden/smbackend/commit/ab6418c16047d069ddd97f0a835018ee50d4a328))
* Use latest base image ([#357](https://github.com/voneiden/smbackend/issues/357)) ([523dc5d](https://github.com/voneiden/smbackend/commit/523dc5d53f8a3c2f0e9d0ed69035a289fa2eb9ea))
* Wrap preschool import in a transaction ([17c477f](https://github.com/voneiden/smbackend/commit/17c477f5ed550edb52e7c7245a0abe934de0e8b1))


### Performance Improvements

* Optimize observation queries ([d85b84f](https://github.com/voneiden/smbackend/commit/d85b84fd24dd0ab5144170cd394b25513bbe13ac))
* Optimize unit filtering queries ([470fb17](https://github.com/voneiden/smbackend/commit/470fb17af20325ffdc177bf46acccb9f7b8db378))
* **search:** Optimize service and unit queries in API ([34fb0da](https://github.com/voneiden/smbackend/commit/34fb0da84696ef330b53720f6e69ce0fa567e099))


### Dependencies

* Add django-csp ([013cf9d](https://github.com/voneiden/smbackend/commit/013cf9d89f40eb0e3e3f61297aae31d5a44b5db0))
* Add uwsgitop ([6f19156](https://github.com/voneiden/smbackend/commit/6f19156f5d8bf0024951c0570fc6b80c0846aff4))
* Bump cryptography from 43.0.1 to 44.0.1 ([8babaa4](https://github.com/voneiden/smbackend/commit/8babaa4106fe9e921ddd2dcf09235ba8264d9751))
* Bump django from 5.1.10 to 5.1.11 ([4e1dfae](https://github.com/voneiden/smbackend/commit/4e1dfae6f0ed18ddeef06f5e75d0a33ba498a49a))
* Bump django from 5.1.11 to 5.1.12 ([f8e9411](https://github.com/voneiden/smbackend/commit/f8e94115eecdeee10049db4206e6b4ef5597cb0f))
* Bump django from 5.1.12 to 5.1.13 ([eb96445](https://github.com/voneiden/smbackend/commit/eb96445107e82b23993fea728e75ca25180c3200))
* Bump django from 5.1.12 to 5.2.7 ([33bbc79](https://github.com/voneiden/smbackend/commit/33bbc79888fa51ddc581ff44cc46bb3b60825097))
* Bump django from 5.1.5 to 5.1.7 ([d007222](https://github.com/voneiden/smbackend/commit/d007222a87596cb820f07ce4378833296f09d7d8))
* Bump django from 5.1.7 to 5.1.8 ([a8bb3df](https://github.com/voneiden/smbackend/commit/a8bb3dfb9ff7d27d2713ab2836dbb7af69d643f1))
* Bump django from 5.1.8 to 5.1.9 ([d60d989](https://github.com/voneiden/smbackend/commit/d60d989e7b5a5f05482478d5e747f0bd3c4b2382))
* Bump django from 5.1.9 to 5.1.10 ([dee55b6](https://github.com/voneiden/smbackend/commit/dee55b61b5de84a7fa8776c90df8530f074d49a0))
* Bump django from 5.2.11 to 5.2.12 ([fbbf602](https://github.com/voneiden/smbackend/commit/fbbf602c2323fe7a87c6adacc619e4ee0ded6a5c))
* Bump django from 5.2.12 to 5.2.13 ([a665b21](https://github.com/voneiden/smbackend/commit/a665b21b24b06a387c0d95f52f6c800c105b087c))
* Bump django from 5.2.7 to 5.2.8 ([62ff365](https://github.com/voneiden/smbackend/commit/62ff36577c9bd21a2a6ac5ad06ca7b692d528678))
* Bump django from 5.2.8 to 5.2.9 ([68eeae5](https://github.com/voneiden/smbackend/commit/68eeae5151e6ca753751900ca416e074ad597b94))
* Bump django from 5.2.9 to 5.2.11 ([06042bd](https://github.com/voneiden/smbackend/commit/06042bd5bd6ebdc561982e9498a837377ba6eec5))
* Bump django-munigeo ([b8e92dc](https://github.com/voneiden/smbackend/commit/b8e92dc2206f37e57a24c7ace8e6d7c8db7ea2a4))
* Bump django-munigeo ([7481db2](https://github.com/voneiden/smbackend/commit/7481db2717d1228514154e21f190a143ffe67fc9))
* Bump django-munigeo ([9782f6d](https://github.com/voneiden/smbackend/commit/9782f6d3f012d7f5de6d433c295ca7957fab3c65))
* Bump lxml from 6.0.2 to 6.1.0 ([b9cde40](https://github.com/voneiden/smbackend/commit/b9cde40c1c08161cc5650f3652e4df197b0a010e))
* Bump pip from 25.2 to 25.3 ([27ace72](https://github.com/voneiden/smbackend/commit/27ace7297260cda889c3d034c6e63bb64bc0ef17))
* Bump pip from 25.2 to 26.0 ([b9c43ce](https://github.com/voneiden/smbackend/commit/b9c43cec626abeea8f128366ad2157913343a26b))
* Bump pip-tools ([c2dabfd](https://github.com/voneiden/smbackend/commit/c2dabfd7ace5397aee7d880bea2b6d5566710372))
* Bump pygments ([47ab51c](https://github.com/voneiden/smbackend/commit/47ab51c88a0113ba83ec74989fad0ec3ca49b3b8))
* Bump pytest from 8.4.2 to 9.0.3 ([0b11ab4](https://github.com/voneiden/smbackend/commit/0b11ab4adccb737d9a533042e52b5bbb5f774664))
* Bump requests from 2.32.3 to 2.32.4 ([ba08511](https://github.com/voneiden/smbackend/commit/ba085119d781d41e5dc82ee5d4ea60b39433f590))
* Bump requests from 2.32.5 to 2.33.0 ([5381363](https://github.com/voneiden/smbackend/commit/5381363b79db2523525df058b7b1c5ff62c2b7e5))
* Bump sentry-sdk and uwsgi versions ([0b87d52](https://github.com/voneiden/smbackend/commit/0b87d52f44d3ec7081238f55dd5787f469563020))
* Bump sentry-sdk from 2.16.0 to 2.39.0 ([5fc83d1](https://github.com/voneiden/smbackend/commit/5fc83d11c29db9e301aeb765ae75cffe96b60066))
* Bump sqlparse from 0.5.3 to 0.5.4 ([ddf7299](https://github.com/voneiden/smbackend/commit/ddf7299e5cc4629eeefd4c9edd30fdeedecb20eb))
* Bump urllib3 from 1.26.20 to 2.5.0 ([4dd0c67](https://github.com/voneiden/smbackend/commit/4dd0c67b35459b3afa61f424131dc27360186f14))
* Bump wheel from 0.45.1 to 0.46.2 ([1e2d0c8](https://github.com/voneiden/smbackend/commit/1e2d0c82d5d3da99b6c83bbf2071fe329319ae73))
* Downgrade urllib3 ([c32464c](https://github.com/voneiden/smbackend/commit/c32464ca106adde32b83d07afae49e7725e62779))
* Move ipython to main requirements for improved console ([698643e](https://github.com/voneiden/smbackend/commit/698643ee2731577df638e2ee305cf5ce71c2d86c))
* Remove ruff from dev requirements ([fd2fb8b](https://github.com/voneiden/smbackend/commit/fd2fb8b2cc15f630382ed5a391bd863ee3095d65))
* Split dev requirements from requirements.in ([b957191](https://github.com/voneiden/smbackend/commit/b95719164bc91385660fd6fd4df8c92942e0901c))
* Upgrade packages, add hashes ([3d93344](https://github.com/voneiden/smbackend/commit/3d933444d733115300bcb5076ea3263e7cf7e47d))
